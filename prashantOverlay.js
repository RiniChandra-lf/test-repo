...
const VpaidNonLinear = class {
  ...
  imageContainer2.id = 'overlayContainer2';
  imageContainer2.style.display = 'block'; // Initially hidden until delay time
  imageContainer2.style.position = 'absolute';
  imageContainer2.style.left = '0';
  imageContainer2.style.height = '131%'; // Reduced to make room for bottom banner
  imageContainer2.style.width = '131%';
  imageContainer2.style.overflow = 'hidden';
  imageContainer2.style.backgroundColor = 'rgba(217, 23, 23, 0.8)'; // Semi-transparent background
  imageContainer2.style.color = 'blue';
  imageContainer2.style.fontWeight = 'bold';
...
imageContainer2.appendChild(video);
  container.appendChild(imageContainer2);
    ...
    @keyframes shrinkAndMove {
      ...
      #overlayContainer2 {
          animation: shrinkAndMove 5s forwards;
          animation-delay: 5s; 
      }
      * {
    ...
    this.carouselStartTimeout_ = setTimeout(() => {
      ...
      if (overlayContainer && bottomImage && bottomStripContainer) {
        ...
        overlayContainer2.style.display = 'block';
